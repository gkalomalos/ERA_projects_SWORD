...
const useStore = create((set, get) => ({
  ...
  setAvailableMacroSectors: (sectors) => set({ availableMacroSectors: sectors }),
  setAvailableMacroVariables: (variables) => set({ availableMacroVariables: variables }),
